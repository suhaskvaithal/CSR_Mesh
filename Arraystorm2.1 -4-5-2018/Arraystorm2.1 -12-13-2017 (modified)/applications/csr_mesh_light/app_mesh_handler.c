...
/* Device Apprearance. */
CSR_MESH_DEVICE_APPEARANCE_T appearance = {"ArrayS",
...
static MESH_HANDLER_DATA_T                     g_mesh_handler_data;
...
/*extern void RestoreLightState(void)
{
    if(g_mesh_handler_data.assoc_state == app_state_associated)
    {
        ...
        LightHardwareSetColor(g_light_handler_data.light_model.red,
